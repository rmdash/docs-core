...
_Result---the current bytes in, bytes out, and current time_
...
_Result---information about the node's connection to the network_
...
| →<br>`localrelay`                      | bool          | Required<br>(exactly 1) | _Added in Bitcoin Core 0.13.0_<br><br>The services supported by this node as advertised in its [`version` message](../reference/p2p-network-control-messages.md#version)                                                                                 |
...
| → →<br>`bytesrecv_per_msg`      | string : <br>object | Required<br>(exactly 1) | _Added in Bitcoin Core 0.13.0_<br><br>Information about total received bytes aggregated by message type                                                                                                                                                                              |
...
The [`listbanned` RPC](../api/remote-procedure-calls-network.md#listbanned) lists all **_manually banned_** IPs/Subnets.
