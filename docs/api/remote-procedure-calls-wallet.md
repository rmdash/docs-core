...
![Warning icon](https://raw.githubusercontent.com/dashpay/docs-core/main/icons/icon_warning.svg) Note: This RPC only returns a balance for addresses contained in the local wallet.
