...
![Full-Service Wallets](https://docs-core.github.io/img/dev/en-wallets-full-service.svg)
...
![Signing-Only Wallets](https://docs-core.github.io/img/dev/en-wallets-signing-only.svg)
...
![Distributing-Only Wallets](https://docs-core.github.io/img/dev/en-wallets-distributing-only.svg)
