...
![Masternode Sync (Initial)](https://docs-core.github.io/img/dev/en-masternode-sync-initial-dip3.svg)
...
![Masternode Sync (Ongoing)](https://docs-core.github.io/img/dev/en-masternode-sync-ongoing.svg)
