...
![Creating A P2SH Redeem Script And Hash](https://docs-core.github.io/img/dev/en-creating-p2sh-output.svg)
...
![Unlocking A P2SH Output For Spending](https://docs-core.github.io/img/dev/en-unlocking-p2sh-output.svg)
