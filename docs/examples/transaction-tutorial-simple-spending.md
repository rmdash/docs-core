...
Shell script to run the previous example (available [here](https://gist.github.com/docs-core/f40bddfc0844ec0d66d196720dc936f8#file-regtest_transaction_simple_spending_example-sh)):
