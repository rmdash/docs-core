...
![Overview Of P2P Protocol Data Request And Reply Messages](https://docs-core.github.io/img/dev/en-p2p-data-messages.svg)
...
![Example Of Parsing A MerkleBlock Message](https://docs-core.github.io/img/dev/animated-en-merkleblock-parsing.gif)
...
![Example Of Creating A MerkleBlock Message](https://docs-core.github.io/img/dev/animated-en-merkleblock-creation.gif)
