...
|---------|------------------------------------|--------------
| 70227 | Dash Core 19.0.0 <br> (Apr 2023) | • Added high-performance masternode type (4000 DASH collateral)<br>• Removed [`reject` message](core-ref-p2p-network-deprecated-messages#reject)
