...
![Overview Of P2P Protocol PrivateSend Request And Reply Messages](https://raw.githubusercontent.com/dashpay/docs-core/main/dev/en-p2p-privatesend-messages.svg)
