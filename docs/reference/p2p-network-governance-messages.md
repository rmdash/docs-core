...
![Overview Of P2P Protocol Governance Request And Reply Messages](https://raw.githubusercontent.com/dashpay/docs-core/main/dev/en-p2p-governance-messages.svg)
